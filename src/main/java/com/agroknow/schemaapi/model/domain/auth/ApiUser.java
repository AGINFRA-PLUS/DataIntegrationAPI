package com.agroknow.schemaapi.model.domain.auth;
...
public class ApiUser implements Serializable {
    ...
    private Map<String, String> preFilters = new HashMap<>();
    ...
    public Map<String, String> getPreFilters() {
        return preFilters;
    }

    public void setPreFilters(Map<String, String> preFilters) {
